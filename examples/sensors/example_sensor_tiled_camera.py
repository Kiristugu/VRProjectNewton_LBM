...
class Example:
    def __init__(self, viewer: ViewerGL):
        ...
        robot_builder = RigidModelBuilder()
        ...
        self.tiled_camera_sensor_color_image = self.tiled_camera_sensor.sensor.create_color_image_output(
            self.sensor_render_width, self.sensor_render_height, self.camera_count
        )
        self.tiled_camera_sensor_depth_image = self.tiled_camera_sensor.sensor.create_depth_image_output(
            self.sensor_render_width, self.sensor_render_height, self.camera_count
        )
        self.tiled_camera_sensor_normal_image = self.tiled_camera_sensor.sensor.create_normal_image_output(
            self.sensor_render_width, self.sensor_render_height, self.camera_count
        )
        self.tiled_camera_sensor_shape_index_image = self.tiled_camera_sensor.sensor.create_shape_index_image_output(
            self.sensor_render_width, self.sensor_render_height, self.camera_count
        )
        self.tiled_camera_sensor_albedo_image = self.tiled_camera_sensor.sensor.create_albedo_image_output(
            self.sensor_render_width, self.sensor_render_height, self.camera_count
        )
    ...
    def render_sensors(self):
        self.tiled_camera_sensor.sensor.update(
