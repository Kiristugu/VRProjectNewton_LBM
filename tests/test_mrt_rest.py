...
"""MRT rest-fluid regression (member B: collide_mrt)."""
...
class TestMrtRestFluid(unittest.TestCase):
    """M1-style acceptance with MRT collision scheme."""

    @classmethod
    def setUpClass(cls) -> None:
        wp.init()

    def test_rest_fluid_mrt_m1(self) -> None:
        grid_size: int = 16
        steps: int = 100
