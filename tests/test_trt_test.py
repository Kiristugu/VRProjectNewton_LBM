...
"""TRT rest-fluid regression (member B: collide_trt)."""
...
class TestTrtRestFluid(unittest.TestCase):
    """M1-style acceptance with TRT collision scheme."""

    @classmethod
    def setUpClass(cls) -> None:
        wp.init()

    def test_rest_fluid_trt_m1(self) -> None:
        grid_size: int = 16
        steps: int = 100
