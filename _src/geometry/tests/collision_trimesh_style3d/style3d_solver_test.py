...
########################################################################################################################
##################################    Test Solver For CollisionTriMeshStyle3D    #######################################
########################################################################################################################
...
from newton._src.solvers.style3d.builder import PDMatrixBuilder
...
from newton._src.solvers.style3d.linear_solver import PcgSolver, SparseMatrixELL
from wanphys._src.geometry.collision_trimesh_style3d import CollisionTriMeshStyle3D
...
class SolverStyle3DTest(SolverBase):
    ...
    def __init__(
        ...
        self.collision: CollisionTriMeshStyle3D | None = CollisionTriMeshStyle3D(model)  # set None to disable
