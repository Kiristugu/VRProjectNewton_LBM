...
#
# Adapted from `newton/examples/cloth/example_cloth_twist.py`.
...
from wanphys._src.geometry.tests.collision_trimesh_vbd.vbd_solver_test import SolverVBDTest
...
class Example:
    def __init__(self, viewer, args=None):
        ...
        # Keep the demo aligned with Newton's example; only the solver implementation differs.
        self.solver = SolverVBDTest(
            self.model,
            self.iterations,
