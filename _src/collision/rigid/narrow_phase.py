...
from newton._src.utils.heightfield import HeightfieldData, create_empty_heightfield_data, get_triangle_from_heightfield_cell
...
from newton._src.geometry.contact_data import SHAPE_PAIR_HFIELD_BIT, ContactData, contact_passes_gap_check
from .sdf_contact import create_narrow_phase_process_mesh_mesh_contacts_kernel
from newton._src.geometry.support_function import SupportMapDataProvider, extract_shape_data
    ...
    def launch(
        ...
        **kwargs: Any,
        ...
        if shape_collision_aabb_lower is None or shape_collision_aabb_upper is None:
            raise TypeError(
                "NarrowPhase.launch() missing required AABB bounds: "
                "provide shape_collision_aabb_lower/shape_collision_aabb_upper"
            )
