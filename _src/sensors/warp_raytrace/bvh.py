...
def compute_mesh_bounds(
    ...
    scale: wp.vec3f,
    mesh_min_bounds: wp.vec3f, 
    mesh_max_bounds: wp.vec3f,
    ...
    corner_0 = wp.transform_point(transform, wp.vec3f(mesh_min_bounds[0], mesh_min_bounds[1], mesh_min_bounds[2]))
    min_bound = wp.min(min_bound, corner_0)
    max_bound = wp.max(max_bound, corner_0)

    corner_1 = wp.transform_point(transform, wp.vec3f(mesh_max_bounds[0], mesh_min_bounds[1], mesh_min_bounds[2]))
    min_bound = wp.min(min_bound, corner_1)
    max_bound = wp.max(max_bound, corner_1)

    corner_2 = wp.transform_point(transform, wp.vec3f(mesh_min_bounds[0], mesh_max_bounds[1], mesh_min_bounds[2]))
    ...
    corner_4 = wp.transform_point(transform, wp.vec3f(mesh_min_bounds[0], mesh_min_bounds[1], mesh_max_bounds[2]))
    min_bound = wp.min(min_bound, corner_4)
    max_bound = wp.max(max_bound, corner_4)

    corner_5 = wp.transform_point(transform, wp.vec3f(mesh_max_bounds[0], mesh_min_bounds[1], mesh_max_bounds[2]))
    min_bound = wp.min(min_bound, corner_5)
    max_bound = wp.max(max_bound, corner_5)

    corner_6 = wp.transform_point(transform, wp.vec3f(mesh_min_bounds[0], mesh_max_bounds[1], mesh_max_bounds[2]))
    min_bound = wp.min(min_bound, corner_6)
    max_bound = wp.max(max_bound, corner_6)

    corner_7 = wp.transform_point(transform, wp.vec3f(mesh_max_bounds[0], mesh_max_bounds[1], mesh_max_bounds[2]))
